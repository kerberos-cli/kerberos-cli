...
import { spawn as cpSpawn, SpawnOptions, fork as cpFork } from 'child_process'
 ...
 */
export const spawn = (cli: string, params?: Array<string>, options?: SpawnOptions, stdout?: Types.ProcessStdout, killToken?: symbol): Promise<any> => {
