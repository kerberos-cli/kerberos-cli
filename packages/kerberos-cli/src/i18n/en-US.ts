...
export const COMMAND__BOOTSTRAP__OPTION_NO_CLONE = 'skip git clone'
...
export const COMMAND__VERSION__ERROR_VERSION = 'The version number entered is lower than the version number in the projects.\n#{1}'
...
export const COMMAND__VERSION__WARN_COMMIT_FAIL = 'Project #{1} failed to submit, please re-tag after submission.'
...
export const COMMAND__RUN_MULTI__OPTION_EXCLUDE = 'specify projects not to excute script'
export const COMMAND__RUN_MULTI__OPTION_ALL = 'specify all projects to excute script'
...
export const COMMAND__EXEC_MULTI__OPTION_EXCLUDE = 'specify projects not to excute command'
export const COMMAND__EXEC_MULTI__OPTION_ALL = 'specify all projects to excute command'
...
// branch
export const INTERCEPTORS__BRANCH__ERROR_INVALID_BRANCH = 'Some projects are in different branches, please switch the following project to #{1} branch.\n#{2}'
